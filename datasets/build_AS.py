...
class BaseDataset(Dataset, metaclass=ABCMeta):
    def __init__(self,
        ...
        if 'ntu' in self.ann_file:
            ...
            # data_path = '/data/ntu/Hyperformer_processed_data/NTU120_NTU120_96-24.npz' # NTU120_NTU120_110-10.npz NTU120_NTU120_96-24.npz
            npz_data = np.load(data_path)
            # print('DATA LOADED \n')
            # print(npz_data['x_train'].shape, npz_data['x_test'].shape)
            ...
            # print('TRAIN DATA SHAPE', hyperformer_data_train.shape)
            ...
            # print('TEST DATA SHAPE', hyperformer_data_test.shape)
            ...
            # print('DATA SHAPE',hyperformer_data.shape)
