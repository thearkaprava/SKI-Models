...
cd skilvlm
python -m skilvlm.single_video_inference \
    --model-name <path of llava weights, for eg "LLaVA-7B-Lightening-v1-1"> \
    --projection_path <path of projection for eg "skilvlm-weights/skilvlm-7B.bin"> \
...
def skilvlm_infer(video_frames, question, conv_mode, model, vision_tower, tokenizer, image_processor, video_token_len):
    """
...
def parse_args():
    ...
    parser.add_argument("--conv_mode", type=str, required=False, default='skilvlm_v1')
...
if __name__ == "__main__":
    ...
    try:
        ...
        output = skilvlm_infer(video_frames, question, conv_mode, model, vision_tower,
