...
torchrun --nproc_per_node=7 --master_port 29001 llavidal/train/train_mem.py \
          ...
          --pose_folder /data/users/asinha13/LLAVIDAL/ntu120_hf_features_7Aug24/ \
          --tune_mm_mlp_adapter True \
          --mm_use_vid_start_end \
          --bf16 True \
          --output_dir ./LLAVIDAL_7B-1.1_Checkpoints_NTU_HF_Pose_5Dec24 \
          --num_train_epochs 3 \
